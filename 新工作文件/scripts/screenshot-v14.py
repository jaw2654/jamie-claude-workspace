"""Screenshot v14 carousel HTML → N PNGs (1080×1080 for IG 1:1)."""
from playwright.sync_api import sync_playwright
from pathlib import Path

HTML = Path("/Users/user/Desktop/Claude cowork/工作文件/public/carousel-v14-metabolism.html").resolve()
OUT = Path("/Users/user/Desktop/Claude cowork/工作文件/public/v14-slides")
...
with sync_playwright() as p:
    ...
    # Force 1:1 1080×1080 per v14 rules
